...
const SnapShot = () => {
	const {value, setvalue}= useState(63448.78)
	...
	return (
		<div className="mt-24">
			<div className="flex flex-wrap  lg:flex-nowrap justify-center ">
				...
				{/*Earnings*/}
				<div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full p-8 pt-9
				 m-3 bg-no-repeat bg-cover bg-center lg:pb-10 ">
					<div className="flex justify-between items-center">
						...
						<button
							...
							className="text-2xl opacity-0.9 font-semibold text-white hover:drop-shadow-xl rounded-full  p-4">
							K
						</button>
					</div>
					<div
			...
			<div className="flex gap-10 flex-wrap justify-center">
				...
				<div>
					...
					<div
						className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl md:w-400 p-8 m-3
...
{/*				<div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
					...
					<p className="text-xs cursor-pointer hover:drop-shadow-xl font-semibold rounded-lg w-24
						...
						<div className="flex gap-4">
							{medicalproBranding.teams.map((item) => (
								<p
									...
									className="cursor-pointer hover:drop-shadow-xl text-white py-0.5 px-3 rounded-lg
									 text-xs">
									{item.name}
								</p>
							))}
